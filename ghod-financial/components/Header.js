        ...
        <ul className="flex space-x-8 items-center font-medium relative z-50">
          ...
          <li className="relative group">
            ...
            <ul className="absolute left-0 top-full mt-2 hidden group-hover:flex flex-col bg-white shadow-xl rounded-lg w-56
              ...
              <li><Link href="/services/bridging-loans"><a className="px-10 py-4 hover:bg-gray-100 whitespace-nowrap">Bridging Loans</a></Link></li>
              <li><Link href="/services/real-estate"><a className="px-5 py-10 hover:bg-gray-100 whitespace-nowrap">Real Estate Finance</a></Link></li>
              <li><Link href="/services/development"><a className="px-5 py-10 hover:bg-gray-100 whitespace-nowrap">Development Loans</a></Link></li>
            </ul>
          </li>
